...
sed -i "s;SMARTCLIDE_THEIA_URL;${SMARTCLIDE_THEIA_URL};g" "${CONFIG_FILE}"
sed -i "s;SMARTCLIDE_SERVICE_DISCOVERY_URL;${SMARTCLIDE_SERVICE_DISCOVERY_URL};g" "${CONFIG_FILE}"